...
// Explanation:
// The message was saved in a regular variable so React was not updating the screen when it changed, I used state for the message instead and now the text changes when I click the button.
